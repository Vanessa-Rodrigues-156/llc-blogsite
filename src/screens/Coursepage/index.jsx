...
export default function CoursePage() {
  ...
  useEffect(() => {
    const coursesData = [
      {
        ...
        instructorBio: "With over 15 years of experience teaching visual arts, Prof. Patel has helped hundreds of students discover their artistic potential. Her work has been featured in national galleries and she holds a Master's degree in Fine Arts from the National Institute of Design.",
        ...
        mediaGallery: [
          { type: "image", src: "/courses/art-course.jpg", caption: "Students working on gesture drawing techniques" },
          { type: "image", src: "/group-young-people-library-1.png", caption: "Portfolio review session" },
    ...
    const selectedCourse = coursesData.find(c => c.id === courseId) || {
      ...
      instructorImage: "/instructor-profile.jpg",
      duration: "12 weeks",
      level: "All Levels",
      ...
      mediaGallery: [
        ...
        { type: "image", src: "/group-students-with-teacher-laboratory-1.png", caption: "Hands-on learning activities" },
