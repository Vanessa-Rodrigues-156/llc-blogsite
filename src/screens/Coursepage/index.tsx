...
export default function CoursePage() {
  ...
  interface Course {
    ...
    outcomes: { title: string; description: string; image: string }[];
  ...
  const getDecorativeBubbleStyle = (index: number) => {
    ...
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <div className="w-full max-w-9xl lg:max-w-full mx-auto py-8 px-4 grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-8">
          ...
          <section className="bg-white p-6 rounded-xl shadow-sm">
            ...
            <div className="prose max-w-none text-[#696983]">
              ...
              {course?.additionalDescription && (
                <p className="mt-4">{course?.additionalDescription}</p>
              )}
              {!course?.additionalDescription && (
                <p className="mt-4">
          ...
          {course?.mediaGallery && course?.mediaGallery.length > 0 && (
            <section className="bg-white p-6 rounded-xl shadow-sm">
          ...
          {course?.testimonials && course?.testimonials.length > 0 && (
            <section className="bg-white p-6 rounded-xl shadow-sm">
              <h2 className="text-2xl font-bold text-[#3465e1] mb-4">Student Testimonials</h2>
